      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="addflyer" method="post" class="" action="<?php echo base_url('article-procedures/editpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
					...
					<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="">
									<textarea id="editor1" name="abstract" rows="2" cols="80" ><?php echo isset($details['abstract'])?$details['abstract']:''; ?>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="">
									<textarea id="editor2" name="biography" rows="2" cols="80" ><?php echo isset($details['biography'])?$details['biography']:''; ?>
