              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
					...
					<a href="<?php echo base_url('article-procedures/status/'.base64_encode($list['id']).'/'.base64_encode($list['status'])); ?>"><i class="fa fa-check-square-o"></i></a>
										&nbsp;&nbsp;

					<a href="<?php echo base_url('article-procedures/delete/'.base64_encode($list['id'])); ?>"><i class="fa fa-trash-o"></i></a>
