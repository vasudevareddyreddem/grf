...
<section class="content-header">
      <h1>
        Edit Conference Image 
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="<?php echo base_url('conference-flyers/lists'); ?>">Conference Flyers List</a></li>
        <li class="active">Edit Conference Image</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Conference Image </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			<div style="padding:20px;">
            <form id="addflyer" method="post" class="" action="<?php echo base_url('conference_images/editpost'); ?>" enctype="multipart/form-data">
							<?php $csrf = array(
						...
						<div class="clearfix">&nbsp;</div>
						  <div class="form-group">
                            <div class="col-lg-4 col-lg-offset-8">
								...
								<a href="<?php echo base_url('conference_images/lists'); ?>" type="submit" class="btn btn-warning" >Cancel</a>
