        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Add Conference process</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			<div style="padding:20px;">
            <form id="addprocessfee" onsubmit="return checkvalidation();" method="post" class="" action="<?php echo base_url('conference-process/addpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
					...
					<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="">
									<input type="text" id="title" name="title" class="form-control" placeholder="Enter Title" ></div>
							</div>
                        </div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="">
									<input type="text" id="url" name="url" class="form-control" placeholder="Enter Url" ></div>
							</div>
                        </div>
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="">
									<input type="text" id="Place" name="place" class="form-control" placeholder="Enter Url" ></div>
							</div>
                        </div>
