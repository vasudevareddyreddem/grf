      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form id="addfaq" method="post" class="" action="<?php echo base_url('faq/addpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="question" id="question" value="" placeholder="Enter Question" />
								</div>
							</div>
                        </div>
						<div class="col-md-8">
