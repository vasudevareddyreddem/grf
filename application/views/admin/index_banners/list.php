<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Index Banner List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Index Banner List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img width="50px" height="50px" src="<?php echo base_url('assets/index_banners/'.$list['image']); ?>">
				  </td>
                  <td><?php if($list['status']==1){ echo "Active"; }else{ echo "deactive";} ?></td>
                  <td>
					<a href="<?php echo base_url('index_images/edit/'.base64_encode($list['b_id'])); ?>"><i class="fa fa-edit"></i></a>
										&nbsp;&nbsp;
