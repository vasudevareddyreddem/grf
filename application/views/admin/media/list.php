              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<td><?php if($list['status']==1){ echo "Active"; }else{ echo "deactive";} ?></td>
                  <td>
					...
					<a href="<?php echo base_url('Media-partner/status/'.base64_encode($list['id']).'/'.base64_encode($list['status'])); ?>"><i class="fa fa-check-square-o"></i></a>
										&nbsp;&nbsp;

					<a href="<?php echo base_url('Media-partner/delete/'.base64_encode($list['id'])); ?>"><i class="fa fa-trash-o"></i></a>
