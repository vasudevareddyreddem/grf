          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
				<?php if($userdetails['profile_pic']!=''){ ?>
					<img src="<?php echo base_url('assets/adminpic/'.$userdetails['profile_pic']); ?>" class="profile-user-img img-responsive img-circle" alt="User Image">
				<?php }else{  ?>
              ...
              <p class="text-muted text-center"><?php echo isset($userdetails['role'])?$userdetails['role']:''; ?></p>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Phone  Number	</b> <a class="pull-right"><?php echo isset($userdetails['phone'])?$userdetails['phone']:''; ?></a>
                </li>
				<li class="list-group-item">
...
<?php echo isset($userdetails['email'])?$userdetails['email']:''; ?>              </p>
              ...
              <p class="h4">
               <?php echo isset($userdetails['phone'])?$userdetails['phone']:''; ?>
              </p>
