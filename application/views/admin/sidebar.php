<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="<?php if(isset($u_url) && $u_url==base_url('indexing')){ echo "active"; } ?> treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Indexing</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('indexing'); ?>"><i class="fa fa-circle-o"></i> Add</a></li>
            <li><a href="<?php echo base_url('indexing/lists'); ?>"><i class="fa fa-circle-o"></i> List</a></li>
          </ul>
        </li>
		<li class="<?php if(isset($u_url) && $u_url==base_url('Media-partner')){ echo "active"; } ?> treeview">
          <a href="#">
		...
		<li class="<?php if(isset($u_url) && $u_url==base_url('Manuscripts')){ echo "active"; } ?> treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Manuscripts</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('manuscripts'); ?>"><i class="fa fa-circle-o"></i> Add</a></li>
            <li><a href="<?php echo base_url('manuscripts/lists'); ?>"><i class="fa fa-circle-o"></i> List</a></li>
          </ul>
        </li>
