...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Edit Video Article</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Edit Video Article</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form id="addvideo"  method="post" class="" action="<?php echo base_url('video/editpost'); ?>" enctype="multipart/form-data">
					<?php $csrf = array(
								...
								'hash' => $this->security->get_csrf_hash()
										...
										<input type="hidden" id="v_id" name="v_id" value="<?php echo isset($details['v_id'])?$details['v_id']:''; ?>">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="publishing_date" id="publishing_date" value="<?php echo isset($details['publishing_date'])?$details['publishing_date']:''; ?>" placeholder="Enter Publishing date" />
								</div>
							</div>
                        </div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="">
									<input type="text" class="form-control" name="accepting_date" id="accepting_date" value="<?php echo isset($details['accepting_date'])?$details['accepting_date']:''; ?>" placeholder="Enter Accepting date" />
								</div>
							</div>
                        </div>
						...
						<div class="clearfix">&nbsp;</div>
						  <div class="form-group">
                            <div class="col-lg-4 col-lg-offset-8">
								...
								<a href="<?php echo base_url('video/lists'); ?>" type="submit" class="btn btn-warning" >Cancel</a>
