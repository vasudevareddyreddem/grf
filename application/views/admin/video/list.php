...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Video Article List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Video Article List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td style="display:none"><?php echo htmlentities($list['v_id']); ?></td>
				   <td>
					<video width="15%"  class="thumbnail">
					<source src="<?php echo base_url('assets/videoarticle/'.$list['video']); ?>" type="video/mp4">
					<source src="movie.ogg" type="video/ogg">
					</video>
				  </td>
                  <td><?php echo $list['publishing_date'];?></td>
                  <td><?php echo $list['accepting_date'];?></td>
                  <td><?php echo htmlentities($list['title']); ?></td>
                  <td><?php echo htmlentities($list['author_name']); ?></td>
                  <td><?php echo htmlentities($list['article_type']); ?></td>
                  <td><?php if($list['status']==1){ echo "Active"; }else{ echo "deactive";} ?></td>
                  <td>
					<a href="<?php echo base_url('video/edit/'.base64_encode($list['v_id'])); ?>"><i class="fa fa-edit"></i></a>
										&nbsp;&nbsp;
