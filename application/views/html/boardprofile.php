           ...
           <div class="col-md-8">
                ...
                <div class=" Welcome_txt fadeInLeft wow animated  " data-wow-duration="1000ms" data-wow-delay="1000ms">
					...
					<div class="col-md-4">
						...
						<tr>
							<th>Name</th>
							<td><?php echo isset($board_member_details['name'])?$board_member_details['name']:''; ?></td>
						</tr>
						<!--<tr>
							<th>Email</th>
							<td><?php echo isset($board_member_details['email'])?$board_member_details['email']:''; ?></td>
						</tr>
						<tr>
							<th>Phone Number</th>
							<td><?php echo isset($board_member_details['phone'])?$board_member_details['phone']:''; ?></td>
						</tr>
						<tr>
							<th>Designation</th>
							<td><?php echo isset($board_member_details['designation'])?$board_member_details['designation']:''; ?></td>
						</tr>-->
						<tr>
							<th>University</th>
							<td><?php echo isset($board_member_details['university'])?$board_member_details['university']:''; ?></td>
						</tr>
						<tr>
							<th>Country</th>
							<td><?php echo isset($board_member_details['country'])?$board_member_details['country']:''; ?></td>
						</tr>
						</table>
					</div>
					</div>
					<br>
						<h3 class="">  
						<span class="text-success">Reviewer Board</span> 
					</h3>
					<p ><?php echo isset($board_member_details['reviewer_board'])?$board_member_details['reviewer_board']:''; ?>
					</p>
